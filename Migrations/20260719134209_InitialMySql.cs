        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleSlots_Psychologists_PsychologistId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Surveys_Psychologists_PsychologistId",
                        column: x => x.PsychologistId,
                        principalTable: "Psychologists",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Surveys_SurveyCategories_SurveyCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PsychologicalProfiles_Psychologists_PsychologistId",
                        column: x => x.PsychologistId,
                        principalTable: "Psychologists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PsychologicalProfiles_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Stress = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Anxiety = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Depression = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SurveyResults_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PsychologicalProfiles_PsychologistId",
                table: "PsychologicalProfiles",
                column: "PsychologistId");

            migrationBuilder.CreateIndex(
                name: "IX_PsychologicalProfiles_StudentId",
                table: "PsychologicalProfiles",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleSlots_PsychologistId",
                table: "ScheduleSlots",
                column: "PsychologistId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyAnswers_QuestionOptionId",
                table: "SurveyAnswers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyResults_StudentId",
                table: "SurveyResults",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Surveys_PsychologistId",
                table: "Surveys",
                column: "PsychologistId");

            migrationBuilder.CreateIndex(
                name: "IX_Surveys_SurveyCategoryId",
                table: "Surveys",
